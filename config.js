module.exports = {
  ...
  TOKEN_SECRET: process.env.TOKEN_SECRET || '@vardhaman1103',

  // OAuth 2.0
  FACEBOOK_SECRET: process.env.FACEBOOK_SECRET || 'b4039cba54a650a58a8af4e41531362f',
  FOURSQUARE_SECRET: process.env.FOURSQUARE_SECRET || 'YOUR_FOURSQUARE_CLIENT_SECRET',
  GOOGLE_SECRET: process.env.GOOGLE_SECRET || '2h3LiRokiyqIb8A2SemuvFt_',
